    ...
    assert response == [
        {
            ...
            "startDateTime": int(mock_alerts[1].start_datetime.timestamp()),
            "endDateTime": int(mock_alerts[1].end_datetime.timestamp()),
        }
    ]
    ...
    assert response == [
        {
            ...
            "startDateTime": int(mock_alerts[2].start_datetime.timestamp()),
